        ...
        if (GlobalVars.currentWeapon != GlobalVars.newWeapon)
        {
            ...
            switch (GlobalVars.currentWeapon)
            {
                ...
                case "DivineHammer":
                    ...
                    break;
                case "TwinDaggers":
                    ChangeWeaponStats(16, 1, 0.6f, 0.15f, "Swift", 0, true, 11);
                    break;
                case "CosmicSpear":
                ...
                case "GoldenShortSword":
                    ChangeWeaponStats(60, 1, 1.2f, 0.15f, "Neutral", 0, true, 13);
                    break;
                case "EmberBattleAxe":
                    ChangeWeaponStats(35, 0, 3.5f, 0.3f, "Fire", 0, true, 14);
                    break;
                case "FrostLongSword":
                    ChangeWeaponStats(70, 1, 1.4f, 0.15f, "Ice", 0.15f, true, 15);
                    break;
                case "ShockLance":
                    ChangeWeaponStats(75, 1, 1f, 0.15f, "Thunder", 0, true, 16);
                    break;
                case "SacredStaff":
                ...
                case "AstralGreatSword":
                    ChangeWeaponStats(90, 1, 1.5f, 0.15f, "Cosmic", 0, true, 19);
                    break;

                //Lvl 4 Weapons
                case "TitaniumShortSword":
                    ChangeWeaponStats(100, 1, 1.2f, 0.15f, "Neutral", 0, true, 20);
                    break;
                case "InfernalLongSword":
                    ChangeWeaponStats(100, 1, 1f, 0.15f, "Fire", 0, true, 21);
                    break;
                case "BlizzardBroadSword":
                    ChangeWeaponStats(50, 0, 4f, 0.3f, "Ice", 0.15f, true, 22);
                    break;
                case "LightningGreatAxe":
                    ChangeWeaponStats(250, 1, 2f, 0.15f, "Thunder", 0, true, 23);
                    break;
                case "HeavenlyGreatSword":
                    ChangeWeaponStats(60, 0, 3.5f, 0.4f, "Holy", 0, true, 24);
                    break;
                case "ReinforcedMorningStar":
                    ChangeWeaponStats(70, 1, 0.4f, 0.15f, "Swift", 0, true, 25);
                    break;
