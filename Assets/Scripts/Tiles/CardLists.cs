...
public class CardsLists : MonoBehaviour
{
    ...
    //Power up cards
    [System.NonSerialized] public List<string> powerUpCards = new List<string> { "Neutral", "Fire", "Ice", "Thunder", "Holy", "Swift", "Cosmic", "FireSpeedUp", "IceSlowUp", "ThunderArmorDmgUp", "HolyRangeUp", "SwiftPsnDmgUp", "CosmicCritChanceUp", "FireBurnUp", "IceRangeUp", "ThunderCritChanceUp", "HolySpeedUp", "SwiftSpeedUp", "CosmicRangeUp", "StonePwr1", "StonePwr2" };
}
