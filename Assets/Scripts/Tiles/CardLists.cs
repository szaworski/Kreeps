...
public class CardsLists : MonoBehaviour
{
    ...
    //Tier 5 Monsters
    [System.NonSerialized] public List<string> ancestralForestMonsterCards = new List<string> { "Ancestral Spirit", "Great Wolf", "Forest Guardian", "Earth Elemental" };
    [System.NonSerialized] public List<string> celestialPlaneMonsterCards = new List<string> { "Celestial Imp", "Celestial Serpent", "Astronaut", "Martian" };
    [System.NonSerialized] public List<string> corruptedIsleMonsterCards = new List<string> { "Rot Raven", "Festering Ghoul", "Noxious Ogre", "Blight Fiend" };
    [System.NonSerialized] public List<string> mysticMountainMonsterCards = new List<string> { "Arcane Eagle", "Arcane Ghoul", "Rune Bear", "Mystic Mage" };
    [System.NonSerialized] public List<string> oceanAbyssMonsterCards = new List<string> { "Colossal Shrimp", "Ghost Ship", "Pirate", "Dolphin" };
    [System.NonSerialized] public List<string> underworldMonsterCards = new List<string> { "Chaos Demon", "Skeleton Lord", "Blood Mage", "Hell Hound" };
    ...
    [System.NonSerialized] public List<string> tier4WeaponCards = new List<string> { "TitaniumShortSword", "InfernalLongSword", "BlizzardBroadSword", "LightningGreatAxe", "HeavenlyGreatSword", "ReinforcedMorningStar", "GalacticScepter" };

    //Power up cards
    [System.NonSerialized] public List<string> powerUpCards = new List<string> { "Neutral", "Fire", "Ice", "Thunder", "Holy", "Swift", "Cosmic", "FireSpeedUp", "IceSlowUp", "ThunderArmorDmgUp", "HolyRangeUp", "SwiftPsnDmgUp", "CosmicCritChanceUp", "FireBurnUp", "IceRangeUp", "ThunderCritChanceUp", "HolySpeedUp", "SwiftSpeedUp", "CosmicRangeUp", "StonePwr1", "StonePwr2" }; //, "StoneInt1", "StoneInt2" 
}
