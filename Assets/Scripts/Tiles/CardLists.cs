...
{
    [System.NonSerialized] public List<string> tier1TileCards = new List<string> { "Forrest", "Forrest", "Forrest", "Forrest", "Forrest" };
    ...
    [System.NonSerialized] public List<string> swampMonsterCards = new List<string> { "Spider", "Alligator", "Frog", "Ghoul" };
}
